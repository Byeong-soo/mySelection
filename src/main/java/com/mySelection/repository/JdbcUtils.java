...
public class JdbcUtils {
    // MySQL DB접속정보
    public static final String url = "jdbc:mysql://localhost:3306/myselectiondb?useUnicode=true&characterEncoding=utf8&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=Asia/Seoul";
